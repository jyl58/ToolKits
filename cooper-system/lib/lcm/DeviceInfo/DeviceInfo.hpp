...
#ifndef __DeviceInfo_DeviceInfo_hpp__
#define __DeviceInfo_DeviceInfo_hpp__
...
int DeviceInfo::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int DeviceInfo::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int DeviceInfo::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t DeviceInfo::getHash()
{
    static int64_t hash = static_cast<int64_t>(_computeHash(NULL));
    return hash;
}

const char* DeviceInfo::getTypeName()
{
    return "DeviceInfo";
}

int DeviceInfo::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int DeviceInfo::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
